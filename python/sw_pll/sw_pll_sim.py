...
def run_sim_sw_pll_lut( target_output_frequency,
    ...
    sigma_delta_loop_ratio = 10000 # for every contol update, we do sigma delta this many times
    sigma_delta_loop_ratio = 1 # for every contol update, we do sigma delta this many times
